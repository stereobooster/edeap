...
//     cy = cy / nCircles;
//     for (let i = 0; i < nCircles; i++) {
//       this.ellipseParamsCopy[i].X = 0.5 + this.ellipseParamsCopy[i].X - cx;
//       this.ellipseParamsCopy[i].Y = 0.5 + this.ellipseParamsCopy[i].Y - cy;
//     }
//   }
...
//         this.ellipseParamsCopy[i].X,
//         this.ellipseParamsCopy[i].Y,
//         this.ellipseParamsCopy[i].A,
//         this.ellipseParamsCopy[i].B,
//         this.ellipseParamsCopy[i].R
//       );
